...
var streams = [ 
    ["VID 0", "https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_ts/master.m3u8"],
    ["VID 1", "https://bitdash-a.akamaihd.net/content/MI201109210084_1/m3u8s/f08e80da-bf1d-4e3d-8899-f0f6155f6efa.m3u8"],
    ["VID 2", "https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8"],
    ["VID 3", "https://mnmedias.api.telequebec.tv/m3u8/29880.m3u8"],
    ["VID 4", "http://184.72.239.149/vod/smil:BigBuckBunny.smil/playlist.m3u8"],
    ["VID 5", "http://www.streambox.fr/playlists/test_001/stream.m3u8"]
];
...
function ControlPanel()
{
    ...
    this.streamResolution = scene.create({t: "text",
							    x: X,
							    y: Y+5,
							    parent: this.background,
							    text:"" });
 
    this.streamBitrate     = scene.create({t: "text",
							    x: X,
							    y: Y+20,
							    parent: this.background,
							    text:"" });
...
ControlPanel.prototype.updateResolution = function(resolution)
{
